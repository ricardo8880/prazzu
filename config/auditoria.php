...
return [
    ...
    */
    ...
    'manual_event_catalog' => [
        ...
        'item_controle.status.changed' => 'Mudança crítica de status de item de controle.',
        'item_controle.vencimento.changed' => 'Mudança crítica de vencimento de item de controle.',
        'item_controle.responsavel.changed' => 'Mudança crítica de responsável de item de controle.',
        'item_controle.sla.changed' => 'Mudança crítica em campos de SLA.',
        'item_controle.approval_status.changed' => 'Mudança crítica no status agregado de aprovação do item.',
        'item_controle.aprovacao.created' => 'Solicitação de aprovação criada.',
        'item_controle.aprovacao.status.changed' => 'Aprovação ou reprovação registrada.',
        'item_controle.aprovacao.response.changed' => 'Resposta de aprovação alterada.',
        'item_controle.anexo.uploaded' => 'Upload de anexo em item de controle.',
        'item_controle.anexo.deleted' => 'Exclusão de anexo em item de controle.',
        'portal_documento.uploaded' => 'Upload de documento no portal.',
        'portal_documento.deleted' => 'Exclusão de documento do portal.',
        'permissao.changed' => 'Criação, alteração ou exclusão de permissão/papel/vínculo de acesso.',
        'financeiro.pagamento.created' => 'Pagamento criado.',
        'financeiro.pagamento.deleted' => 'Pagamento excluído.',
        'financeiro.pagamento.status.changed' => 'Status de pagamento alterado.',
        'financeiro.pagamento.paid_at.changed' => 'Data de pagamento alterada.',
        'financeiro.pagamento.valor.changed' => 'Valor de pagamento alterado.',
        'financeiro.assinatura.created' => 'Assinatura criada.',
        'financeiro.assinatura.deleted' => 'Assinatura excluída.',
        'financeiro.assinatura.status.changed' => 'Status de assinatura alterado.',
        'financeiro.assinatura.cancelled_at.changed' => 'Cancelamento de assinatura alterado.',
        'financeiro.assinatura.plan.changed' => 'Plano de assinatura alterado.',
        'financeiro.assinatura.valor.changed' => 'Valor de assinatura alterado.',
    ],
    ...
    'high_risk_events' => [
        ...
        'item_controle.approval_status.changed',
