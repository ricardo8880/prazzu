                        ...
                        <div class="at-ticket-modal-actions">
                            <details class="at-ticket-control">
                                ...
                                <div class="at-ticket-control-panel">
                                    ...
                                    <button type="button" wire:click="mudarStatusRapido({{ $selectedAtendimento['id'] }}, 'fechado')" class="danger"><span class="at-dot danger"></span> Encerrar atendimento</button>
                                </div>
                            </details>
                            ...
                            <details class="at-ticket-control at-ticket-more-control">
                                ...
                                <div class="at-ticket-control-panel at-ticket-more-panel">
                                    ...
                                    <button type="button" class="danger" wire:click="mudarStatusRapido({{ $selectedAtendimento['id'] }}, 'fechado')"><i class="bi bi-x-octagon" aria-hidden="true"></i> Encerrar atendimento</button>
                                </div>
                            </details>
                        ...
                        <aside class="at-ticket-right">
                            ...
                            <section class="at-ticket-panel">
                                ...
                                <div class="at-ticket-quick-list">
                                    ...
                                    <button type="button" class="at-ticket-quick-btn danger" wire:click="mudarStatusRapido({{ $selectedAtendimento['id'] }}, 'fechado')"><span class="at-dot danger"></span> Encerrar atendimento</button>
                                </div>
                            </section>
