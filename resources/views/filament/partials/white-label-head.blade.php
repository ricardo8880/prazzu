...
@if($isWhiteLabelLoginPage)
    ...
    <style id="prazzu-white-label-login-runtime">
        :root {
            --wl-login-background: {{ $loginBackground }};
            --wl-login-side-image: @if($loginSideImage) url('{{ $loginSideImage }}') @else none @endif;
        }
