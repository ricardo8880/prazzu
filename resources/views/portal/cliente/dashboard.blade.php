...
<head>
    ...
    <script>
        window.__PORTAL_CLIENTE_DEBUG_CONTEXT__ = {
            ...
            cliente_id: @json($cliente->id ?? null),
            atendimento_id: @json($atendimentoAtual['id'] ?? null),
            protocolo: @json($atendimentoAtual['protocolo'] ?? null),
            abrir_formulario: @json($abrirFormulario ?? false)
        };
