...
<head>
    ...
    <title>{{ $brandName }} | Gestão de documentos, prazos e processos</title>
    ...
    <section class="hero">
        <div class="container hero-grid">
            <div>
                ...
                <p>
                    O {{ $brandName }} centraliza documentos, vencimentos, responsáveis,
                ...
                <div class="hero-actions">
                    <a class="btn btn-primary" href="{{ route('empresa.cadastro.create') }}">Começar teste grátis</a>
                    <a class="btn btn-dark" href="#planos">Ver planos</a>
                    <a class="btn btn-light" href="{{ route('portal.cliente.login') }}">Área do Cliente</a>
                    <a class="btn btn-light" href="{{ url('/admin/login') }}">Área Administrativa</a>
                </div>
        ...
        <div class="container">
            <div class="cta-box">
                <div>
                    ...
                    <p>Teste grátis por 7 dias, receba implantação gratuita e veja se o {{ $brandName }} encaixa na sua rotina.</p>
                </div>
...
<footer class="footer">
    <div class="container">
        © {{ date('Y') }} {{ $brandName }}. Gestão de documentos, prazos e processos em formato SaaS.
    </div>
</footer>
</body>
</html>
