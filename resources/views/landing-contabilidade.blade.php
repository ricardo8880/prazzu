...
<head>
    ...
    <title>{{ $brandName }} | Plataforma para contabilidades</title>
...
<header class="topbar">
    <div class="container nav">
        ...
        <div class="nav-actions">
            <a class="btn btn-light" href="{{ route('portal.cliente.login') }}">Área do Cliente</a>
            <a class="btn btn-light" href="{{ url('/admin/login') }}">Entrar</a>
            <a class="btn btn-primary" href="{{ route('empresa.cadastro.create') }}">Testar grátis</a>
        </div>
    </div>
</header>
...
<main>
    <section class="hero">
        <div class="container hero-grid">
            <div>
                ...
                <p>
                    Pare de perder arquivos no WhatsApp, e-mail e planilhas. O {{ $brandName }} organiza solicitações,
                ...
                <div class="hero-actions">
                    <a class="btn btn-primary" href="{{ route('empresa.cadastro.create') }}">Começar grátis</a>
    ...
    <section class="section" id="recursos">
        <div class="container">
            <div class="section-header">
                <h2>O que sua contabilidade ganha com o {{ $brandName }}.</h2>
        ...
        <div class="container">
            ...
            <div class="plans-grid">
                <article class="plan-card" data-plan-base="0">
                    ...
                    <a class="btn btn-light" href="{{ route('empresa.cadastro.create', ['plano' => 'starter']) }}">Começar grátis</a>
                </article>
                ...
                <article class="plan-card highlight js-plan-card" data-plan-base="39">
                    ...
                    <a class="btn btn-primary" href="{{ route('empresa.cadastro.create', ['plano' => 'profissional']) }}">Assinar Starter</a>
                </article>
                ...
                <article class="plan-card js-plan-card" data-plan-base="89">
                    ...
                    <a class="btn btn-light" href="{{ route('empresa.cadastro.create', ['plano' => 'business']) }}">Escolher Pro</a>
                </article>
                ...
                <article class="plan-card js-plan-card" data-plan-base="179">
                    ...
                    <a class="btn btn-light" href="{{ route('empresa.cadastro.create', ['plano' => 'enterprise']) }}">Falar com especialista</a>
                </article>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <div class="cta-box">
                ...
                <a class="btn btn-primary" href="{{ route('empresa.cadastro.create') }}">Criar conta grátis</a>
