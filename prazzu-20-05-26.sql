...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Maio-2026 às 22:18
...
CREATE TABLE `atendimentos` (
  ...
  `status` enum('aberto','em_andamento','aguardando_cliente','resolvido','fechado','cancelado') NOT NULL DEFAULT 'aberto',
...
CREATE TABLE `atendimento_interacoes` (
  ...
  `origem` enum('interno','cliente','sistema') NOT NULL DEFAULT 'interno',
  `tipo` enum('abertura','comentario','alteracao','responsavel','resposta','resolucao','reabertura','sistema') NOT NULL DEFAULT 'comentario',
