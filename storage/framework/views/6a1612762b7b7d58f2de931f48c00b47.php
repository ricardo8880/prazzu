...
<script>
    ...
    window.PrazzuAccountingProfiles = <?php echo json_encode($accountingProfiles, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES, 512) ?>;
    window.PrazzuCurrentAccountingProfile = <?php echo json_encode($currentAccountingProfile, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES, 512) ?>;
    window.PrazzuAccountingAdministrativeLabels = <?php echo json_encode($accountingAdministrativeLabels, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES, 512) ?>;
