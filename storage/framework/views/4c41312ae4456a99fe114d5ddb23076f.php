...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="dec-cockpit" data-executive-accounting-dashboard>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($templatesContabeis) && ((int) ($templatesContabeis['tasks_open'] ?? 0) > 0 || (int) ($templatesContabeis['templates_active'] ?? 0) > 0)): ?>
            <section class="dec-panel" aria-label="Integração dos templates contábeis">
                <header class="dec-panel__header">
                    ...
                    <strong><?php echo e((int) ($templatesContabeis['tasks_open'] ?? 0)); ?></strong>
                </header>
                ...
                <div class="dec-decision-grid dec-spaced-top">
                    <article class="dec-decision dec-decision--static dec-tone-info">
                        ...
                        <strong><?php echo e((int) ($templatesContabeis['templates_active'] ?? 0)); ?></strong>
                    ...
                    <article class="dec-decision dec-decision--static dec-tone-warning">
                        ...
                        <strong><?php echo e((int) ($templatesContabeis['processes_open'] ?? 0)); ?></strong>
                    ...
                    <article class="dec-decision dec-decision--static dec-tone-danger">
                        ...
                        <strong><?php echo e((int) ($templatesContabeis['tasks_late'] ?? 0)); ?></strong>
                        <p>Tarefas de templates fora do prazo.</p>
                    </article>
                    <article class="dec-decision dec-decision--static dec-tone-warning">
                        <span class="dec-decision__label">Bloqueios</span>
                        <strong><?php echo e((int) ($templatesContabeis['blocked'] ?? 0)); ?></strong>
                        <p>Dependências, documentos ou aprovações pendentes.</p>
                    </article>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($templateRiskRows)): ?>
                    <div class="dec-action-list dec-spaced-top">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $templateRiskRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <article class="dec-action dec-tone-<?php echo e($item['tone'] ?? 'warning'); ?>">
                                <div class="dec-action__top">
                                    <div>
                                        <h3><?php echo e($item['title'] ?? 'Tarefa de template'); ?></h3>
                                        <small><?php echo e($item['meta'] ?? 'Template contábil'); ?></small>
                                    </div>
                                    <span><?php echo e($item['status'] ?? 'Atenção'); ?></span>
                                </div>
                                <p><?php echo e($item['description'] ?? 'Tarefa integrada ao ecossistema operacional.'); ?></p>
                                <div class="dec-action__footer">
                                    <em><?php echo e(! empty($item['deadline']) ? 'Prazo ' . $item['deadline'] : 'Sem prazo'); ?></em>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($item['url'])): ?>
                                        <a href="<?php echo e($item['url']); ?>"><?php echo e($item['action_label'] ?? 'Abrir tarefa'); ?></a>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </article>
