    ...
    <div class="pc-service-shell" wire:poll.2500ms.visible="atualizarConversa" x-data="{
        ...
        <div class="pc-workspace">
            ...
            <section class="pc-panel pc-main" aria-label="Conversa com o cliente">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($clienteDigitando): ?>
                    <div class="pc-typing-row" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'cliente-digitando-indicador'; ?>wire:key="cliente-digitando-indicador">
                        <span class="pc-typing-dots" aria-hidden="true"><i></i><i></i><i></i></span>
                        <span><?php echo e($clienteDigitandoNome ?: 'Cliente'); ?> está digitando...</span>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\sistemrh\resources\views/filament/pages/portal-cliente.blade.php ENDPATH**/ ?>