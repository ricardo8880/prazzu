        ...
        <section class="contabilidade-lote3-scope" aria-label="Propósito da Timeline Operacional">
            <div class="contabilidade-lote3-scope__top">
                ...
                <div class="contabilidade-lote3-actions">
                    <a class="contabilidade-lote3-action primary" href="<?php echo e(\App\Filament\Pages\CentroOperacional::getUrl()); ?>"><i class="bi bi-command"></i> Mesa Operacional</a>
                    <a class="contabilidade-lote3-action" href="<?php echo e(\App\Filament\Pages\SlaPrazos::getUrl()); ?>"><i class="bi bi-clock-history"></i> SLA</a>
                </div>
            </div>
        </section>
