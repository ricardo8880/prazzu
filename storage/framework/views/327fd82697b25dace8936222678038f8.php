...
<header class="portal-area-topbar">
    <div class="portal-area-brand">
        ...
        <div class="portal-area-title">
            ...
            <p><?php echo e($empresaNome); ?> · acompanhe seus atendimentos com segurança.</p>
        </div>
    </div>

    <div class="portal-area-user">
        <div class="portal-area-avatar" aria-hidden="true"><?php echo e(strtoupper($iniciais)); ?></div>
        <div>
            <strong><?php echo e($clienteNome); ?></strong><br>
            <small><?php echo e($cliente->email ?? ''); ?></small>
        </div>
        <form method="POST" action="<?php echo e(route('portal.cliente.logout')); ?>">
            <?php echo csrf_field(); ?>
...
<main class="portal-area-shell">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
        <div class="portal-alert is-success"><?php echo e(session('success')); ?></div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $estruturaDisponivel): ?>
        ...
        <section class="portal-dashboard-grid">
            <aside class="portal-panel portal-panel-pad">
                ...
                <div class="portal-summary" aria-label="Resumo dos atendimentos">
                    <div class="portal-summary-card"><strong><?php echo e($resumo['total']); ?></strong><span>Total</span></div>
                    <div class="portal-summary-card"><strong><?php echo e($resumo['abertos'] + $resumo['andamento']); ?></strong><span>Ativos</span></div>
                    <div class="portal-summary-card"><strong><?php echo e($resumo['aguardando']); ?></strong><span>Aguardando</span></div>
                    <div class="portal-summary-card"><strong><?php echo e($resumo['finalizados']); ?></strong><span>Finalizados</span></div>
                </div>

                <a class="portal-primary-action" href="<?php echo e(route('portal.cliente.atendimentos.create')); ?>">+ Novo atendimento</a>

                <div class="portal-ticket-list">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $atendimentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $atendimento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <a class="portal-ticket-item <?php echo e(($atendimentoAtual['id'] ?? null) === $atendimento['id'] ? 'is-active' : ''); ?>" href="<?php echo e($atendimento['url']); ?>">
                            <div class="portal-ticket-top">
                                <div>
                                    <div class="portal-ticket-title"><?php echo e($atendimento['titulo']); ?></div>
                                    <p class="portal-ticket-desc"><?php echo e(Str::limit($atendimento['descricao'] ?: 'Sem descrição registrada.', 95)); ?></p>
                                </div>
                                <span class="portal-badge <?php echo e($atendimento['status_badge']); ?>"><?php echo e($atendimento['status_label']); ?></span>
                            </div>
                            <div class="portal-ticket-meta">
                                <span><?php echo e($atendimento['protocolo']); ?></span>
                                <span>•</span>
                                <span><?php echo e($atendimento['interacoes_total']); ?> interação(ões)</span>
                                <span>•</span>
                                <span><?php echo e($atendimento['updated_at_label']); ?></span>
                            </div>
                        </a>
            ...
            <section class="portal-panel">
                <div class="portal-chat-head">
                    <div class="portal-chat-title">
                        <h2><?php echo e($abrirFormulario ? 'Novo atendimento' : ($atendimentoAtual['titulo'] ?? 'Atendimento')); ?></h2>
                        <p><?php echo e($abrirFormulario ? 'Preencha os dados para abrir um chamado com o suporte.' : ($atendimentoAtual['protocolo'] ?? 'Selecione um atendimento')); ?> <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $abrirFormulario && $atendimentoAtual): ?> · <?php echo e($atendimentoAtual['updated_at_label']); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></p>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $abrirFormulario && $atendimentoAtual): ?>
                        <span class="portal-badge <?php echo e($atendimentoAtual['status_badge']); ?>"><?php echo e($atendimentoAtual['status_label']); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($abrirFormulario): ?>
                    <div class="portal-create-wrap">
                        <div class="portal-create-card">
                            ...
                            <form class="portal-create-form" method="POST" action="<?php echo e(route('portal.cliente.atendimentos.store')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="portal-form-grid">
                                    <div class="portal-field">
                                        ...
                                        <input class="portal-input" id="titulo" name="titulo" value="<?php echo e(old('titulo')); ?>" maxlength="180" required placeholder="Ex.: Dúvida sobre contrato, documento ou acesso">
                                    </div>
                                    <div class="portal-field">
                                        <label for="prioridade">Prioridade</label>
                                        <select class="portal-select" id="prioridade" name="prioridade" required>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $prioridades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valor => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <option value="<?php echo e($valor); ?>" <?php if(old('prioridade', 'media') === $valor): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                ...
                                <div class="portal-field">
                                    ...
                                    <input class="portal-input" id="categoria" name="categoria" value="<?php echo e(old('categoria')); ?>" maxlength="120" placeholder="Ex.: Financeiro, documentos, contrato, acesso">
                                </div>

                                <div class="portal-field">
                                    <label for="descricao">Descrição</label>
                                    <textarea class="portal-textarea" id="descricao" name="descricao" required maxlength="6000" placeholder="Explique o que aconteceu, o que precisa ser analisado e qualquer detalhe importante."><?php echo e(old('descricao')); ?></textarea>
                                    <small>Não inclua senhas ou dados sensíveis.</small>
                                </div>

                                <div class="portal-form-actions">
                                    <a class="portal-secondary-action" href="<?php echo e(route('portal.cliente.dashboard')); ?>">Cancelar</a>
                ...
                <?php else: ?>
                    <div id="portal-tab-atendimento" class="portal-tab-panel is-active" style="display:block;">
                        <div id="portal-chat-body" class="portal-chat-body <?php echo e($atendimentoAtual ? 'has-composer' : ''); ?>">
                            ...
                            <?php elseif($interacoes === []): ?>
                                <div class="portal-empty">
                                    <strong>Histórico ainda vazio.</strong><br>
                                    Envie uma mensagem abaixo para iniciar a conversa com o suporte.
                                </div>
                            <?php else: ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $interacoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $interacao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <article class="portal-message <?php echo e($interacao['is_cliente'] ? 'is-client' : 'is-support'); ?>">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! ($interacao['is_cliente'])): ?>
                                            <div class="portal-message-avatar" aria-hidden="true">S</div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                        <div class="portal-message-bubble">
                                        <span class="portal-message-author">
                                            <?php echo e($interacao['is_cliente'] ? $clienteNome : ($interacao['usuario_nome'] ?? 'Equipe de suporte')); ?>

                                            · <?php echo e($interacao['tipo_label']); ?>

                                        </span>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($interacao['mensagem'] ?? '')) !== ''): ?>
                                                <?php echo nl2br(e((string) ($interacao['mensagem'] ?? ''))); ?>

                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($interacao['anexos'])): ?>
                                                <div class="portal-attachment-list">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $interacao['anexos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anexo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                        <div>
                                                            <div class="portal-attachment-card">
                                                                <div class="portal-attachment-icon" aria-hidden="true"><?php echo e(strtoupper($anexo['extensao'] ?? 'ARQ')); ?></div>
                                                                <div class="portal-attachment-info">
                                                                    <strong><?php echo e($anexo['nome_original']); ?></strong>
                                                                    <span><?php echo e($anexo['tamanho_label']); ?> · <?php echo e($anexo['mime']); ?></span>
                                                                </div>
                                                                <a class="portal-attachment-download" href="<?php echo e($anexo['download_url']); ?>">Baixar</a>
                                                            </div>

                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($anexo['is_imagem'])): ?>
                                                                <img class="portal-attachment-preview" src="<?php echo e($anexo['preview_url']); ?>" alt="Prévia do anexo <?php echo e($anexo['nome_original']); ?>">
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        </div>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                </div>
                                            ...
                                            <span class="portal-message-time"><?php echo e($interacao['created_at_label']); ?></span>
                                        </div>

                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($interacao['is_cliente']): ?>
                                            <div class="portal-message-avatar" aria-hidden="true"><?php echo e(strtoupper(substr($clienteNome, 0, 1))); ?></div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </article>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($atendimentoAtual): ?>
                            ...
                            <div class="portal-chat-composer">
                                ...
                                <?php else: ?>
                                    <form id="portal-chat-form" method="POST" enctype="multipart/form-data" action="<?php echo e(route('portal.cliente.atendimentos.mensagem', ['atendimento' => $atendimentoAtual['id']])); ?>">
                                        <?php echo csrf_field(); ?>
                                        <input type="text" name="website" value="" autocomplete="off" tabindex="-1" style="position:absolute;left:-9999px;height:1px;width:1px;opacity:0;">
                                        <div class="portal-chat-input-wrap">
                                            <textarea id="portal-chat-textarea" onkeydown="return window.portalClienteEnviarEnter(event, this);" class="portal-chat-textarea" name="mensagem" maxlength="6000" rows="1" placeholder="Digite sua mensagem para o suporte..."><?php echo e(old('mensagem')); ?></textarea>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                            <span class="portal-field-error"><?php echo e($message); ?></span>
                                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['anexo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="portal-info-wrap">
                                <div class="portal-info-card">
                                    <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap;">
                                        ...
                                        <a class="portal-primary-action" href="<?php echo e(route('portal.cliente.atendimentos.create')); ?>" style="width:auto;margin-top:0;white-space:nowrap;">+ Novo problema</a>
                                    </div>
                                </div>
                                ...
                                <div class="portal-info-card">
                                    ...
                                    <div class="portal-ticket-list" style="max-height:none;margin-top:14px;padding-right:0;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $atendimentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <a class="portal-ticket-item <?php echo e(($atendimentoAtual['id'] ?? null) === $ticket['id'] ? 'is-active' : ''); ?>" href="<?php echo e($ticket['url']); ?>#tab-atendimento">
                                                <div class="portal-ticket-top">
                                                    <div>
                                                        <div class="portal-ticket-title"><?php echo e($ticket['protocolo']); ?> · <?php echo e($ticket['titulo']); ?></div>
                                                        <p class="portal-ticket-desc"><?php echo e(Str::limit($ticket['descricao'] ?: 'Sem descrição registrada.', 120)); ?></p>
                                                    </div>
                                                    <span class="portal-badge <?php echo e($ticket['status_badge']); ?>"><?php echo e($ticket['status_label']); ?></span>
                                                </div>
                                                <div class="portal-ticket-meta">
                                                    <span><?php echo e($ticket['prioridade_label']); ?></span>
                                                    <span>•</span>
                                                    <span><?php echo e($ticket['interacoes_total']); ?> interação(ões)</span>
                                                    <span>•</span>
                                                    <span>Atualizado <?php echo e($ticket['updated_at_label']); ?></span>
                                                </div>
                                            </a>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            <div class="portal-empty">
                                ...
                                <div class="portal-info-card">
                                    ...
                                    <div class="portal-status-grid">
                                        <div class="portal-status-card"><span>Status atual</span><strong><?php echo e($atendimentoAtual['status_label']); ?></strong></div>
                                        <div class="portal-status-card"><span>SLA/Prazo</span><strong><?php echo e($atendimentoAtual['sla_limite_label']); ?></strong></div>
                                        <div class="portal-status-card"><span>Responsável</span><strong><?php echo e($atendimentoAtual['responsavel_nome']); ?></strong></div>
                                        <div class="portal-status-card"><span>Última atualização</span><strong><?php echo e($atendimentoAtual['updated_at_label']); ?></strong></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="portal-tab-status" class="portal-tab-panel" style="display:none;" hidden>
                            <div class="portal-info-wrap">
                                <div class="portal-info-card">
                                    ...
                                    <div class="portal-status-grid">
                                        <div class="portal-status-card"><span>Status</span><strong><?php echo e($atendimentoAtual['status_label']); ?></strong></div>
                                        <div class="portal-status-card"><span>Protocolo</span><strong><?php echo e($atendimentoAtual['protocolo']); ?></strong></div>
                                        <div class="portal-status-card"><span>Prioridade</span><strong><?php echo e($atendimentoAtual['prioridade_label']); ?></strong></div>
                                        <div class="portal-status-card"><span>Abertura</span><strong><?php echo e($atendimentoAtual['created_at_label']); ?></strong></div>
                                        <div class="portal-status-card"><span>Atualização</span><strong><?php echo e($atendimentoAtual['updated_at_label']); ?></strong></div>
                                        <div class="portal-status-card"><span>Responsável</span><strong><?php echo e($atendimentoAtual['responsavel_nome']); ?></strong></div>
                                        <div class="portal-status-card"><span>Prazo/SLA</span><strong><?php echo e($atendimentoAtual['sla_limite_label']); ?></strong></div>
                                        <div class="portal-status-card"><span>Interações</span><strong><?php echo e(count($interacoes)); ?></strong></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="portal-info-wrap">
                                <div class="portal-info-card">
                                    ...
                                    <div class="portal-history-list">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $interacoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $interacao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <article class="portal-history-item">
                                                <div class="portal-history-head">
                                                    <strong><?php echo e($interacao['is_cliente'] ? $clienteNome : ($interacao['usuario_nome'] ?? 'Equipe de suporte')); ?> · <?php echo e($interacao['tipo_label']); ?></strong>
                                                    <span><?php echo e($interacao['created_at_label']); ?></span>
                                                </div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim((string) ($interacao['mensagem'] ?? '')) !== ''): ?>
                                                    <div class="portal-history-message"><?php echo nl2br(e((string) ($interacao['mensagem'] ?? ''))); ?></div>
                                                <?php else: ?>
            ...
            <aside class="portal-panel portal-panel-pad portal-right-panel">
                ...
                <?php elseif($atendimentoAtual): ?>
                    <div class="portal-detail-list">
                        <div class="portal-detail-row"><span>Status</span><strong><?php echo e($atendimentoAtual['status_label']); ?></strong></div>
                        <div class="portal-detail-row"><span>Protocolo</span><strong><?php echo e($atendimentoAtual['protocolo']); ?></strong></div>
                        <div class="portal-detail-row"><span>Prioridade</span><strong><?php echo e($atendimentoAtual['prioridade_label']); ?></strong></div>
                        <div class="portal-detail-row"><span>Abertura</span><strong><?php echo e($atendimentoAtual['created_at_label']); ?></strong></div>
                        <div class="portal-detail-row"><span>Atualização</span><strong><?php echo e($atendimentoAtual['updated_at_label']); ?></strong></div>
                        <div class="portal-detail-row"><span>Responsável</span><strong><?php echo e($atendimentoAtual['responsavel_nome']); ?></strong></div>
                        <div class="portal-detail-row"><span>Prazo/SLA</span><strong><?php echo e($atendimentoAtual['sla_limite_label']); ?></strong></div>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function renderPortalMessages(messages) {
            ...
            chatBody.innerHTML = messages.map(function (msg) {
                ...
                var avatar = isClient ? '<?php echo e(strtoupper(substr($clienteNome, 0, 1))); ?>' : 'S';
...
<?php /**PATH C:\xampp\htdocs\prazzu\resources\views/portal/cliente/dashboard.blade.php ENDPATH**/ ?>