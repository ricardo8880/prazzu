...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="tp-page">
        ...
        <div class="tp-hero">
            <div>
                <span class="tp-eyebrow"><?php echo e($this->aba === 'validades' ? 'DOCUMENTOS' : 'TRABALHO'); ?></span>
                <h2><?php echo e($this->aba === 'validades' ? 'Validades e Vencimentos' : 'Monitor de SLA e Prazos'); ?></h2>
                <p><?php echo e($this->aba === 'validades' ? 'Controle documental de vencidos, próximos vencimentos, lembretes e acesso rápido ao item.' : 'Visão de apoio para prazos e SLA. A execução continua na Central Operacional; aqui o foco é enxergar risco de atraso.'); ?></p>
            </div>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->aba === 'sla-prazos'): ?>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->aba === 'validades'): ?>
        <?php if (isset($component)) { $__componentOriginalee08b1367eba38734199cf7829b1d1e9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalee08b1367eba38734199cf7829b1d1e9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.section.index','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::section'); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
             ...
             <?php $__env->slot('heading', null, []); ?> Validades e vencimentos documentais <?php $__env->endSlot(); ?>
             <?php $__env->slot('description', null, []); ?> Conteúdo centralizado da antiga aba Validades e Vencimentos dentro de SLA e Prazos. <?php $__env->endSlot(); ?>

            <div class="tp-metrics tp-metrics-4">
                <div class="tp-card"><span>Com validade</span><strong><?php echo e(number_format($resumoValidades['total'] ?? 0, 0, ',', '.')); ?></strong><small>itens com data</small></div>
                <div class="tp-card tp-danger"><span>Vencidos</span><strong><?php echo e(number_format($resumoValidades['vencidos'] ?? 0, 0, ',', '.')); ?></strong><small>ação imediata</small></div>
                <div class="tp-card"><span>Próx. 7 dias</span><strong><?php echo e(number_format($resumoValidades['sete_dias'] ?? 0, 0, ',', '.')); ?></strong><small>urgente</small></div>
                <div class="tp-card tp-success"><span>Concluídos</span><strong><?php echo e(number_format($resumoValidades['concluidos'] ?? 0, 0, ',', '.')); ?></strong><small>encerrados</small></div>
            </div>
            ...
            <div class="tp-sla-modal-columns">
                <div class="tp-detail-card">
                    ...
                    <div class="tp-info-list">
                        <p><span>Sem data</span><b><?php echo e(number_format($resumoValidades['sem_data'] ?? 0, 0, ',', '.')); ?></b></p>
                        <p><span>Próx. 30 dias</span><b><?php echo e(number_format($resumoValidades['trinta_dias'] ?? 0, 0, ',', '.')); ?></b></p>
                    </div>
                </div>
                ...
                <div class="tp-detail-card">
                    ...
                    <div class="tp-info-list">
                        <p><span>Criar validade</span><b><a href="<?php echo e(\App\Filament\Resources\ItemControles\ItemControleResource::getUrl('create')); ?>">Novo item</a></b></p>
                        <p><span>Dashboard</span><b><a href="<?php echo e(\App\Filament\Resources\ItemControles\ItemControleResource::getUrl('dashboard-tabelas')); ?>">Ver dados</a></b></p>
                    </div>
                </div>
            </div>
                ...
                <table class="tp-table tp-sla-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $validades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $validade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td><strong><?php echo e($validade['titulo']); ?></strong><small><?php echo e(\Illuminate\Support\Str::limit($validade['descricao'], 55)); ?></small></td>
                                <td><?php echo e($validade['empresa']); ?></td>
                                <td><?php echo e($validade['tipo']); ?></td>
                                <td><span class="tp-badge"><?php echo e($validade['prioridade']); ?></span></td>
                                <td><span class="tp-badge <?php if($validade['vencido']): ?> tp-badge-danger <?php endif; ?>"><?php echo e($validade['status']); ?></span></td>
                                <td><strong><?php echo e($validade['vencimento']); ?></strong><small><?php echo e($validade['situacao']); ?></small></td>
                                <td><strong><?php echo e(number_format($validade['lembretes'], 0, ',', '.')); ?></strong><small>Último: <?php echo e($validade['ultimo_lembrete']); ?></small></td>
                                <td><a href="<?php echo e($validade['url']); ?>" class="tp-table-link-button">Abrir</a></td>
                            </tr>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
