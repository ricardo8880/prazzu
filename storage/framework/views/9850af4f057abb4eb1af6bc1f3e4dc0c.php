        ...
        <section class="contabilidade-lote3-scope" aria-label="Propósito do Kanban">
            <div class="contabilidade-lote3-scope__top">
                ...
                <div class="contabilidade-lote3-actions">
                    <a class="contabilidade-lote3-action primary" href="<?php echo e(\App\Filament\Pages\Pendencias::getUrl()); ?>"><i class="bi bi-list-check"></i> Abrir Pendências</a>
                    <a class="contabilidade-lote3-action" href="<?php echo e(\App\Filament\Pages\CentroOperacional::getUrl()); ?>"><i class="bi bi-command"></i> Mesa</a>
                </div>
            </div>
        </section>
