    ...
    <section class="section" id="planos">
        <div class="container">
            <div class="section-header">
                ...
                <p>Escolha uma base mensal e ajuste usuários, itens, assinaturas, anexos e IA nos selects. O valor muda na hora conforme a quantidade escolhida.</p>
            </div>
            ...
            <div class="plans-grid">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $planosComerciais; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $codigoPlano => $planoComercial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                        ...
                        $limiteAnexos = (int) ($planoComercial['limite_anexos'] ?? 0);
                        $limiteAssinaturas = (int) ($planoComercial['limite_assinaturas_clicksign'] ?? 0);
                        $usuariosTexto = $limiteUsuarios >= 999999 ? 'Usuários sob demanda' : 'Até ' . number_format($limiteUsuarios, 0, ',', '.') . ' usuários';
                        $itensTexto = number_format($limiteItens, 0, ',', '.') . ' itens inclusos';
                        $assinaturasTexto = $limiteAssinaturas > 0 ? number_format($limiteAssinaturas, 0, ',', '.') . ' assinaturas Clicksign inclusas' : 'Sem assinatura Clicksign inclusa';
                        $anexosTexto = number_format($limiteAnexos, 0, ',', '.') . ' anexos inclusos';
                        $pacotesExtras = $planoComercial['pacotes_extras'] ?? [];
                        $ctaTexto = 'Começar no ' . ($planoComercial['nome'] ?? 'plano');
                    ?>
                    ...
                    <article class="plan-card <?php echo e(! empty($planoComercial['destaque']) ? 'highlight' : ''); ?>">
                        ...
                        <?php echo $__env->make('components.planos.configurador-consumo', [
...
<?php /**PATH C:\xampp\htdocs\sistemrh\resources\views/welcome.blade.php ENDPATH**/ ?>