...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($configuradoresConsumo)): ?>
    ...
    <?php if (! $__env->hasRenderedOnce('0be6eb1f-c83a-4970-9443-8637a985fa85')): $__env->markAsRenderedOnce('0be6eb1f-c83a-4970-9443-8637a985fa85'); ?>
        <style>
    ...
    <?php endif; ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\xampp\htdocs\sistemrh\resources\views/components/planos/configurador-consumo.blade.php ENDPATH**/ ?>