...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <label class="documentos-resolver-field documentos-resolver-field--full">
                ...
                <textarea rows="4" wire:model.defer="resolverObservacao.<?php echo e($documento['id']); ?>" placeholder="Ex.: documento recebido do cliente, novo vencimento conferido, arquivo substituído."></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="documentos-resolver-footer documentos-resolver-footer--dialog">
                <div>
                    ...
                    <a href="<?php echo e($documento['enterprise_url'] ?? $documento['edit_url']); ?>">Abrir edição completa</a>
                </div>
