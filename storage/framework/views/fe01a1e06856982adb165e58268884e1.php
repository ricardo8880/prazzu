...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="ad-page">
        ...
        <form method="GET" action="<?php echo e(url()->current()); ?>" class="ad-filters ad-filters--ux">
            <div class="ad-filter-field ad-filter-field--wide">
                <label for="busca">Buscar na auditoria</label>
                <input id="busca" name="busca" type="search" value="<?php echo e($filtros['busca'] ?? ''); ?>" placeholder="Usuário, empresa, campo, valor, IP, módulo ou evento">
            </div>
            ...
            <div class="ad-filter-field">
                ...
                <select id="evento" name="evento">
                    ...
                    <option value="login.success" <?php if(($filtros['evento'] ?? '') === 'login.success'): echo 'selected'; endif; ?>>Login realizado</option>
                    <option value="login.failed" <?php if(($filtros['evento'] ?? '') === 'login.failed'): echo 'selected'; endif; ?>>Falha de login</option>
                    <option value="auditoria.exported" <?php if(($filtros['evento'] ?? '') === 'auditoria.exported'): echo 'selected'; endif; ?>>Auditoria exportada</option>
                </select>
            </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($filtrosAtivos)): ?>
                <div class="ad-active-filters">
                    <strong>Filtros ativos:</strong>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $filtrosAtivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filtroAtivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <span><?php echo e($filtroAtivo); ?></span>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </form>
        ...
        <section class="ad-metrics ad-metrics--five">
            <article class="ad-metric-card"><span>Total no filtro</span><strong><?php echo e(number_format((int) ($metricas['total'] ?? 0), 0, ',', '.')); ?></strong><small>Tudo que corresponde ao recorte atual</small></article>
            <article class="ad-metric-card ad-metric-card--info"><span>Hoje</span><strong><?php echo e(number_format((int) ($metricas['hoje'] ?? 0), 0, ',', '.')); ?></strong><small>Movimentações do dia</small></article>
            <article class="ad-metric-card ad-metric-card--warning"><span>Alterações</span><strong><?php echo e(number_format((int) ($metricas['alteracoes'] ?? 0), 0, ',', '.')); ?></strong><small>Campos que mudaram de valor</small></article>
            <article class="ad-metric-card ad-metric-card--danger"><span>Exclusões</span><strong><?php echo e(number_format((int) ($metricas['exclusoes'] ?? 0), 0, ',', '.')); ?></strong><small>Registros removidos</small></article>
            <article class="ad-metric-card ad-metric-card--critical"><span>Revisar</span><strong><?php echo e(number_format((int) ($metricas['suspeitas'] ?? 0), 0, ',', '.')); ?></strong><small>Senhas, permissões, status, exportações e falhas</small></article>
        </section>
        ...
        <section class="ad-panel ad-panel--large ad-focus-panel">
            <div class="ad-panel-header">
                ...
                <div class="ad-panel-counter"><?php echo e(number_format((int) $recentes->count(), 0, ',', '.')); ?> recentes</div>
            </div>
                        ...
                        <div class="ad-timeline-item ad-timeline-item--ux">
                            ...
                            <div class="ad-timeline-content">
                                ...
                                <div class="ad-timeline-meta">
                                    ...
                                    <span>Módulo: <?php echo e($this->moduloLabel($registro->auditable_type)); ?></span>
                                    <span>Registro: <?php echo e($this->registroLabel($registro)); ?></span>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $suspeitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <article class="ad-sensitive-card">
                            ...
                            <div class="ad-timeline-meta">
                                ...
                                <span><?php echo e($this->nomeEmpresa($registro)); ?></span>
                            </div>
                        </article>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
                    ...
                    <div class="ad-chart">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $eventos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="ad-chart-row">
                                <div class="ad-chart-label"><span class="ad-badge <?php echo e($evento['classe']); ?>"><?php echo e($evento['label']); ?></span></div>
                                <div class="ad-chart-track"><div class="ad-chart-bar" style="width: <?php echo e($evento['percentual']); ?>%"></div></div>
