...
<head>
    ...
    <title><?php echo e($brandName); ?> | Gestão de prazos, documentos e controles</title>
...
<header class="topbar">
    <div class="container nav">
        ...
        <nav class="nav-links" aria-label="Navegação principal">
            ...
            <a href="<?php echo e(route('empresa.cadastro.create')); ?>">Cadastro</a>
        </nav>

        <div class="nav-actions">
            <a class="btn btn-light" href="<?php echo e(url('/admin/login')); ?>">Logar</a>
            <a class="btn btn-primary" href="<?php echo e(route('empresa.cadastro.create')); ?>">Alugar SaaS</a>
        </div>
    </div>
</header>
    ...
    <section class="hero">
        <div class="container hero-grid">
            <div>
                ...
                <p>
                    O <?php echo e($brandName); ?> centraliza itens de controle, vencimentos, responsáveis,
                    checklist, aprovações, portal do cliente, relatórios e assistente virtual em uma única plataforma.
                </p>

                <div class="hero-actions">
                    <a class="btn btn-primary" href="<?php echo e(route('empresa.cadastro.create')); ?>">Alugar SaaS agora</a>
                    <a class="btn btn-dark" href="<?php echo e(url('/admin/login')); ?>">Já sou cliente</a>
...
<footer class="footer">
    <div class="container">
        © <?php echo e(date('Y')); ?> <?php echo e($brandName); ?>. Gestão de prazos, documentos e controles em formato SaaS.
    </div>
</footer>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\prazzu\resources\views\welcome2.blade.php ENDPATH**/ ?>