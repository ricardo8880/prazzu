...
class ListItemControlesAssinaturas extends ListRecords
{
    ...
    protected static ?string $title = 'Tarefas - Portal e Assinaturas';
    ...
    {
        $this->bootItemControlePerformanceDiagnostics('assinaturas');

        return ItemControleResource::getEloquentQueryForContext('assinaturas');
    }

    public function table(Table $table): Table
    {
        return ItemControlesTable::make($table, 'assinaturas');
    }
}
