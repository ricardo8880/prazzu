...
class ListItemControlesChecklist extends ListRecords
{
    ...
    protected static ?string $title = 'Tarefas - Checklist';
    ...
    {
        $this->bootItemControlePerformanceDiagnostics('checklists');

        return ItemControleResource::getEloquentQueryForContext('checklists');
    }

    public function table(Table $table): Table
    {
        return ItemControlesTable::make($table, 'checklists');
    }
}
